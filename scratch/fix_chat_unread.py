...
# Insert unread computing logic just before building channels
# actually wait, availableChannels is built, then getChannelId is defined.
...
text = text.replace('  return (', unread_logic)
...
# Also fix the button showing the active channel so it doesn't show badge, we just leave it as name.

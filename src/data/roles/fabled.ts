...
export const Fabled: Record<string, Role> = {
  ...
  'bootlegger2': { id: 'bootlegger2', name: '我是村規王', alignment: 'good', type: 'fabled', icon: '/character/character_bootlegger2_fabled.png', ability: '這個劇本採用村規。' },
  ...
  'fabled_charactor': { id: 'fabled_charactor', name: '傳奇角色', alignment: 'good', type: 'fabled', icon: 'https://botcgrimoire.top/img/fableds.efacc32a.png', ability: '這是一個傳奇角色。' },
  ...
  'onion': { id: 'onion', name: '大聰花', alignment: 'good', type: 'fabled', icon: '/imgs/icons/fabled/onion.webp', ability: '這是一個傳奇大聰花。' },
  ...
  'zuiyingdeshangdi': { id: 'zuiyingdeshangdi', name: '嘴硬的上帝', alignment: 'good', type: 'fabled', icon: 'https://botcgrimoire.top/img/duck.bd99fd34.png', ability: '"我可能有問題，但我就是不承認也不說"' },
};

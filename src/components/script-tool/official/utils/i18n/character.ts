export const cn = {
  ...
  'firstNight': '首夜順序',
  'otherNight': '其他夜晚順序',
  'storytellerReminders': '說書人提醒',
  'firstNightReminder': '首夜提醒',
  'otherNightReminder': '其他夜晚提醒',
  'reminderTokens': '提醒標記',
  'addReminder': '新增提醒標記（回車確認）',
  'addReminderPlaceholder': '輸入提醒內容',
  'globalReminderTokens': '全域性提醒標記',
  'addGlobalReminder': '新增全域性提醒標記（回車確認）',
  'addGlobalReminderPlaceholder': '輸入全域性提醒內容',
  'preview': '預覽',
  'character.edit': '編輯',
  'character.delete': '刪除',
  'character.copyJson': '複製角色JSON',
  'character.createCustom': '新建自定義角色',
  'character.customName': '自定義角色',
  'character.customAbility': '自定義',
  'character.jsonCopied': '角色JSON已複製到剪貼簿！',
  'character.jsonCopyFailed': '複製失敗，請重試',
  'character.replace': '更換角色',
  ...
  'title.edit': '編輯標題',
  'title.editFirstPage': '編輯第一頁標題',
  'title.editSecondPage': '編輯第二頁標題',
  'title.title': '劇本標題',
  'title.titleText': '標題文本',
  'title.titleImage': '標題圖片連結（可選）',
  'title.subtitle': '副標題（可選）',
  'title.author': '作者',
  'title.playerCount': '適合人數（可選）',
  'title.fontSize': '標題字型大小',
  'title.fontSizeXs': '手機端',
  'title.fontSizeSm': '平板端',
  'title.fontSizeMd': '桌面端',
  'title.imageSize': '圖片大小',
  'title.useImage': '使用圖片標題',
  'title.showFlourish': '顯示標題印花',
  'title.imageUrl': '圖片連結',
  'title.dragDropHint': '拖拽圖片到此處或',
  'title.clickUpload': '點選上傳',
  'title.save': '儲存',
  'title.cancel': '取消',
  ...
  'specialRules.selectType': '選擇規則型別',
